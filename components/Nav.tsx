...
export default function Nav() {
  ...
  return (
    // Desktop/tablet only; sticky at the top
    <header className="hidden md:block sticky top-0 z-40 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-header">
